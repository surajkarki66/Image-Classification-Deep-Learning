...
from models.inception_module import InceptionModule_1, InceptionModule_2, \
    InceptionModule_3, InceptionModule_4, InceptionModule_5, InceptionAuxOutput, Preprocess
...
class InceptionV3(tf.keras.Model):
    def __init__(self, num_class, aux_logits=True):
        ...
        if self.aux_logits:
            self.AuxLogits = InceptionAuxOutput(num_classes=num_class)
